...
export const AGENDA_ITEMS: AgendaItem[] = [
  ...
  { time: "08:24", activity: "Prepared Speech #1", role: "...", duration: "7m", type: AgendaItemType.NORMAL },
  { time: "08:31", activity: "Prepared Speech #2", role: "...", duration: "7m", type: AgendaItemType.NORMAL },
  { time: "08:38", activity: "Prepared Speech #3", role: "...", duration: "7m", type: AgendaItemType.NORMAL },
  { time: "08:45", activity: "Evaluation Speech #1", role: "...", duration: "3m", type: AgendaItemType.NORMAL },
  { time: "08:48", activity: "Evaluation Speech #2", role: "...", duration: "3m", type: AgendaItemType.NORMAL },
  { time: "08:51", activity: "Evaluation Speech #3", role: "...", duration: "3m", type: AgendaItemType.NORMAL },
  { time: "08:54", activity: "Group Photo", role: "...", duration: "10m", type: AgendaItemType.NORMAL },
  
  { time: "", activity: "BREAK TIME 10 MIN", role: "", duration: "", type: AgendaItemType.SECTION_HEADER },
  { time: "09:04", activity: "Table Topic Speeches", role: "...", duration: "30m", type: AgendaItemType.NORMAL },
  { time: "09:34", activity: "Table Topic Evaluation", role: "...", duration: "6m", type: AgendaItemType.NORMAL },
  { time: "09:40", activity: "Timer Report", role: "...", duration: "3m", type: AgendaItemType.NORMAL },
  { time: "09:43", activity: "Grammarian Report", role: "...", duration: "3m", type: AgendaItemType.NORMAL },
  { time: "09:46", activity: "General Evaluator Report", role: "...", duration: "10m", type: AgendaItemType.NORMAL },
  
  { time: "", activity: "CONCLUSION", role: "", duration: "", type: AgendaItemType.SECTION_HEADER },
  { time: "09:56", activity: "Vote", role: "...", duration: "1.5m", type: AgendaItemType.NORMAL },
  { time: "09:58", activity: "Moment of Truth", role: "...", duration: "5m", type: AgendaItemType.NORMAL },
  { time: "10:03", activity: "Awards", role: "...", duration: "2m", type: AgendaItemType.NORMAL },
  { time: "10:05", activity: "Closing Remark", role: "...", duration: "3m", type: AgendaItemType.NORMAL },
];